...
class BamlSyncClient:
    ...
    def GeneralAssist(self, query: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="GeneralAssist", args={
                "query": query,
            })
...
class BamlStreamClient:
    ...
    def GeneralAssist(self, query: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GeneralAssist", args={
            "query": query,
        })
...
class BamlHttpRequestClient:
    ...
    def GeneralAssist(self, query: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GeneralAssist", args={
            "query": query,
        }, mode="request")
        return __result__
    def SelectSkill(self, query: str,skills: typing.List["types.SkillOption"],
